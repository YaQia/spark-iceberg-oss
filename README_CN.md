...
- **官方 Apache Spark 3.5.0** 基础镜像，包含 Scala 2.12、Java 11 和 Python 3
- **最新 Apache Iceberg 1.5.0** 运行时，支持现代化表格式功能
...
| Apache Iceberg | 1.5.0 | 大规模分析数据集的表格式 |
| Hadoop Aliyun | 3.3.4 | OSS 文件系统实现 |
| Aliyun SDK OSS | 3.17.4 | 阿里云 OSS 客户端库 |
